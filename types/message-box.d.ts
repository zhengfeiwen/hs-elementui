...
export declare class HsMessageBoxComponent extends Vue {
  title: string
  message: string
  type: MessageType
  iconClass: string
...
export interface HsMessageBoxOptions {
  ...
  callback?: (action: MessageBoxCloseAction, instance: HsMessageBoxComponent) => void

  /** Callback before MessageBox closes, and it will prevent MessageBox from closing */
  beforeClose?: (action: MessageBoxCloseAction, instance: HsMessageBoxComponent, done: (() => void)) => void
...
export interface HsMessageBoxShortcutMethod {
  (message: string, title: string, options?: HsMessageBoxOptions): Promise<MessageBoxData>
  (message: string, options?: HsMessageBoxOptions): Promise<MessageBoxData>
}

export interface HsMessageBox {
  /** Show a message box */
  (message: string, title?: string, type?: string): Promise<MessageBoxData>

  /** Show a message box */
  (options: HsMessageBoxOptions): Promise<MessageBoxData>

  /** Show an alert message box */
  alert: HsMessageBoxShortcutMethod

  /** Show a confirm message box */
  confirm: HsMessageBoxShortcutMethod

  /** Show a prompt message box */
  prompt: HsMessageBoxShortcutMethod

  /** Set default options of message boxes */
  setDefaults (defaults: HsMessageBoxOptions): void
